...
var rootCmd = &cobra.Command{
	Use:   "ldap-user-tool",
	Short: "LDAP user management tool for your-domain.org",
...
var createCmd = &cobra.Command{
	...
	Example: `  ldap-user-tool create --first "John" --last "Doe" --email jdoe@example.com
  ldap-user-tool create --first "John" --last "Doe" --email jdoe@example.com --groups printing-a,admins-cups
  ldap-user-tool create --first "John" --last "Doe" --uid hhalladj --email jdoe@example.com --password "MyP@ss123!" --no-email`,
	RunE: runCreate,
}
