...
var userCreateCmd = &cobra.Command{
	...
	Example: `  ldap-admin-tool user create --first "John" --last "Doe" --email jdoe@example.com
  ldap-admin-tool user create --first "John" --last "Doe" --email jdoe@example.com --groups printing-a,admins-cups
  ldap-admin-tool user create --first "John" --last "Doe" --uid hhalladj --email jdoe@example.com --password "MyP@ss123!" --no-email`,
	RunE: runUserCreate,
}
